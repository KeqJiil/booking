...
> Diagram rendered wider than the page on purpose (`useMaxWidth: false`) — on GitHub it will be horizontally scrollable but readable at full size, instead of being squeezed to fit and becoming tiny.
